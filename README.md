...
>
> **Version:** v2.1 | Updated: 2026-01-28
>
> **New:** 本系统现在支持多用户。Clone 后构建你自己的 Profile，调用 Asher 的共享知识库。详见 [GETTING_STARTED.md](GETTING_STARTED.md)
...
| v2.1 | 2026-01-28 | 多用户支持：新增 Profile Init Protocol、Base Attributes 模板、用户技能模块系统、GETTING_STARTED.md 使用教程 |
